...
[assembly: OwinStartupAttribute(typeof(MDC.Startup))]
namespace MDC
{
    public partial class Startup
    {
        ...
        private void CreateRolesandUsers(IAppBuilder app)
        {
            ...
            using (var context = new ApplicationDbContext()) { 
                ...
                foreach (var role in (RuoloEnum[])System.Enum.GetValues(typeof(RuoloEnum)))
                {
                ...
                {
                    var result1 = UserManager.AddToRole(user.Id, System.Enum.GetValues(typeof(RuoloEnum)).GetValue(0).ToString());
                    if (result1.Succeeded == false)
                        throw new System.Exception(result1.Errors.FirstOrDefault().ToString());
                }
